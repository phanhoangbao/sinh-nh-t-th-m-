...
<head>
    ...
    <title>Chúc Mừng Sinh Nhật Pé Thắm</title>
    <style>
        body {
            background-color: #ffe6f0; /* Màu nền hồng phấn */
        ...
        /* Hiệu ứng trái tim rơi - Kiểu 2: Rơi zigzag */
        .heart-zigzag {
            position: absolute;
            width: 20px;
            height: 20px;
        ...
        .heart:nth-child(23) { left: 60%; animation-delay: 0.2s; }
